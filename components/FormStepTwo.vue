  ...
  <div>
    <div class="flex items-center md:justify-center justify-start md:h-screen md:bg-[#f8f8f8] bg-white md:py-0 py-4">
      <div class="mx-auto max-w-[420px] w-full bg-white rounded p-6 md:shadow md:shadow-slate-100">
        ...
        <form>
          <div class="flex items-center justify-start gap-2 py-2 px-4 rounded-xl mb-6 bg-gray-100">
          ...
          <div class="flex items-center justify-start gap-4 p-4 border-gray-200 border-2 rounded-xl my-6 cursor-pointer hover:bg-gray-100 transition">
