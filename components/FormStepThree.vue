<template>
  <div>
    ...
    <div class="flex items-ceenter justify-between gap-4">
      ...
      <div @click="navigateTo('/thank-you')" class="w-1/3 flex items-center justify-start gap-4 p-4 border-gray-200 border-2 rounded-xl mb-2 cursor-pointer hover:bg-red-500 hover:text-white transition cursor-pointer">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 20 20">
